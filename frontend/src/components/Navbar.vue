  ...
  <nav class="navbar">
    <div class="navbar-content container">
      ...
      <ul :class="['navbar-nav', { open: menuOpen }]">
        ...
        <li v-if="!isAuthenticated"><router-link to="/company" @click="closeMenu">Company</router-link></li>
        <li v-if="!isAuthenticated"><router-link to="/bank" @click="closeMenu">Bank</router-link></li>
